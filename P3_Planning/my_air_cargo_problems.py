...
class AirCargoProblem(Problem):
    def __init__(self, cargos, planes, airports, initial: FluentState, goal: list):
        ...
        """
        self.state_map = initial.pos + initial.neg # fluent_map
    ...
    def actions(self, state: str) -> list:
        ...
        """
        # TODO implement
        # Create a KB for propositional logic
        kb = PropKB()
        
        # Place the positive clauses of 'state' into the KB
        kb.tell(decode_state(state, self.state_map).pos_sentence())
        
        # Check the KB for the positive and negative preconditions 
        # of each action and add the action if all preconditions are met. 
        possible_actions = [action for action in self.actions_list if action.check_precond(kb, action.args)]
        names = [p.name for p in possible_actions]
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        '''
        "The simplest idea is to relax the problem by removing all preconditions from
